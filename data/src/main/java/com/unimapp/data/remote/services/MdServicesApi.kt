...
interface MdServicesApi {
    ...
    suspend fun getFaculties(@Query("lang") lang: String): ApiResult<ApiContent<List<Faculty>>>

    @GET("api/v1/md/interests")
    suspend fun getInterest(@Query("lang") lang: String): ApiResult<ApiContent<List<Interest>>>

    @GET("api/v1/md/universities")
    suspend fun getUniversities(@Query("lang") lang: String): ApiResult<ApiContent<List<University>>>
